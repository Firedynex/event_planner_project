...
public class ApiCaller {
  ...
  /**
   * Gets the host country and stores it in {@code hostCountry} for easy access.
   *
  ...
  private void getKey() {
    try {
      ...
      BufferedInputStream apiKeyFile = new BufferedInputStream(
          new FileInputStream("D:\\Coding Projects\\Private_Keys.properties"));
